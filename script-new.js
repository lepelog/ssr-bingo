...
var bingoList = [
    ...
    "Trial|Harp|Complete any Silent Realm",
    ...
    "Bug Net|Minigames|Expert Bug Heaven in under 2m",
    "Bug Net|Minigames|Win Both Bug Wrangler Modes",
    "Minigames|Complete Fun Fun Island",
    "Minigames|Harp|Play the Harp Minigame",
    "Minigames|Clear a Thrill Digger board",
    "Minigames|Win 3 different Minigames",
    "Minigames|Win all Minigames",
    "Minigames|Win Fun Fun Island",
    "Bow|Minigames|600 Points in Pumpkin Archery",
    ...
    "Find an Ammo expansion",
    "Treasures|Medium Ammo Expansion",
    "Treasures|Large Ammo Expansion",
    ...
    "Rupees|spend 1000 Rupees",
    "Rupees|spend 1500 Rupees",
    ...
    "Quests|Complete both romance quest",
    "Quests|Complete one romance quest",
    "Quests|4 Gratitude Crystal Quests",
    "Quests|6 Gratitude Crystal Quests",
    "Quests|7 Gratitude Crystal Quests",
    "Quests|8 Gratitude Crystal Quests",
    ...
    "Enter ET without using the KEY",
    "Enter Skyview without hitting the crystal",
    "Progessive Items|3 Progressive Items",
    "Progessive Items|5 Progressive Items",
    "Progessive Items|7 Progressive Items",
    "Progessive Items|9 Progressive Items",
    "Scale|Talk to Yerbal",
];
